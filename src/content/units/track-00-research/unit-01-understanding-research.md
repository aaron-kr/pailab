---
title: "Understanding the Academic Research Process"
title_ko: "학술 연구 과정 이해하기"
featuredImgUrl: "/img/curriculum/pai-robot-arm.png"
image: "/img/curriculum/pai-robot-arm.png"
...
description_ko: "아이디어 구상부터 초안 작성, 수정, 제출 준비에 이르기까지 연구 수행에 대한 실용적인 안내서."
duration: "30-60 minutes"
objectives:
  - "Learn the lifecycle of a research project"
  - "Understand how to conduct effective research experiments, collect, and analyze data"
  - "Understand the value of scholarly contribution"
objectives_ko:
  - "연구 프로젝트의 전체 과정을 학습합니다."
  - "효과적인 연구 실험을 수행하고 데이터를 수집 및 분석하는 방법을 이해합니다."
  - "학술적 기여의 가치를 이해합니다."
order: 1
---
...
In a nutshell, academic research is an _iterative_ process of:

1. **Questioning:** Ask clear, structured questions
2. **Experimenting:** Systematically investigate those questions 
   - through <ins>experiments</ins>
   - and <ins>data analysis</ins>
...
> Start with a Question.<br>What problem are you trying to solve? Write it in one sentence.

## 1. Choose a Topic

Identifying a <ins>general area of interest</ins> that is:
...
- **`E` – Ethical:** Will an institutional review board (IRB) approve it? (See also [Unit 10 →](./unit-10-research-ethics))
...
**Key skill:** reading papers <ins>efficiently</ins>, not deeply at first.<br>
**See also:** [Unit 2 →](./unit-02-finding-citing-sources)
...
**Key point:** Your method determines what kind of answer you can get.<br>
**See also:** [Unit 3 →](./unit-03-experiments-data)
...
We can use various methods to analyze and visualize data, but the following questions will help you <ins>interpret</ins> your data:

- What _patterns_ are present in the data?
- What does the data _actually_ show?
- Are there alternative explanations?

It is important to remember that numbers and graphs alone do not help others <ins>understand</ins> your data. Data interpretation requires _more_ than mere reiteration of numbers and graphs. It may require one or more of the following:
...
**Key point:** Always aim to answer the <mark>"So what?"</mark> question for your audience.<br>
**See also:** [Unit 3 →](./unit-03-experiments-data)
...
**See also:** [Unit 4 →](./unit-04-writing-imrad)
...
**Key point:** If no one understands it, your work doesn’t function as research.<br>
**See also:**
- [Unit 4 →](./unit-04-writing-imrad) (Writing Papers)
- [Unit 5 →](./unit-05-presenting-research) (Presenting at Conferences)
- [Unit 6 →](./unit-06-getting-published) (Publishing in Journals)
- [Unit 7 →](./unit-07-capstone-design) (Capstone Design)
...
> Correlation does not necessarily mean causation.<br>
> See also [Spurious Correlations](https://www.tylervigen.com/spurious-correlations) | [가짜 상관관계라?](https://kejdev.github.io/machinelearning/2022/08/14/spurious-correlation.html)
...
> Think of research as: “A structured argument supported by evidence.”<br>
...
7. [ ] What _kind_ of data will you collect? (Quantitative or qualitative)
8. [ ] Are there patterns in the data you collected? What does it _actually_ show?
9. [ ] Are there alternative explanations for the patterns in your data? What are they?
10. [ ] "So what?" What do the patterns in your data actually _mean_?
