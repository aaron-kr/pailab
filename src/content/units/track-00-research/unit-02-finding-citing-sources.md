...
description_ko: "연구 수행의 전반적인 과정과 구조를 정리한 가이드입니다."
duration: "30 minutes"
eyebrow: "Research · Starting Out"
objectives:
  - "Learn how to find quality references"
  - "Access your university's library database search engine"
  - "Write citations according to the proper format"
order: 2
---
...
Before anything else, return to your Research Question.<br>
_What information do you need to know to answer your Research Question?_

## 1. Identify Keywords

Example topic:

> “How does <mark>chatbot feedback</mark> affect <mark>student learning outcomes</mark>?”
...
| Literature reviews | Topic overviews |
| Conference papers | New/emerging research |
| Books | Foundational theory |
| Government reports | Statistics and policy |

Some places to search:

- [Google Scholar ↗](https://scholar.google.com/)
- [Research Gate ↗](https://www.researchgate.net/search.Search.html?query=&type=publication)
- [University library databases](#) - This may be the best place to start as most are able to search through multiple academic databases for articles including:
  - Research journals
...
Helpful source collecting tools include: [Zotero ↗](https://www.zotero.org/), [Mendeley ↗](https://www.mendeley.com/download-reference-manager/), [EndNote ↗](https://endnote.com/?srsltid=AfmBOopf393OQ2IsMHLSZMXxE4s16NOWHRjhsEBjtqgm_uUZMOf3XiE-), and citation generators. These tools save time, but: **⚠ Always double-check formatting errors.**
...
| Source (Author, Year) | Research Aim | Methodology | Key Findings | The "Gap" or Limitation |
|---|---|---|---|---|
