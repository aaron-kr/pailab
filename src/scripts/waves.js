  ...
  function initWaves() {
    ...
    heroes.forEach(function (hero) {
      ...
      requestAnimationFrame(function () {
        ...
        initGrad.addColorStop(0,   'rgba(36,255,252,0.15)');
        initGrad.addColorStop(0.5, 'rgba(61,146,245,0.10)');
        initGrad.addColorStop(1,   'rgba(36,255,252,0.15)');
      ...
      function frame(ts) {
        ...
        // Oscillating cyan ↔ blue gradient (coords relative to center)
        var grad = ctx.createLinearGradient(-w, 0, w, h);
        var t = time % 1;
        var side = Math.floor(time % 2) === 0;
        var cA = hsl(side ? 181 : 212, 90, 60);
        var cB = hsl(side ? 212 : 181, 85, 62);
